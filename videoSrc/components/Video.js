...
import { View, StyleSheet, NativeModules, Platform,Dimensions } from 'react-native';
...
class Video extends Component {
    constructor(props) {
        ...
        if (Platform.OS === 'android') {
            const config = {                            //Setting config of the app
                ...
                token:'0066f34509475f744aca6a424121df35245IABI4abxRG7WLdJuSg5hd1KurQ4I+JApevOY6COMOy6oULBzJ0IAAAAAEAATrPMFYm/fXQEAAQBhb99d',
    ...
    componentDidMount() {
        ...
        RtcEngine.on('joinChannelSuccess', (data) => {
            debugger;//If Local user joins RTC channel
